...
const GIT_ENV = {
  ...process.env,
  GIT_AUTHOR_NAME: "c2d-test",
  GIT_AUTHOR_EMAIL: "test@c2d.local",
  GIT_COMMITTER_NAME: "c2d-test",
  GIT_COMMITTER_EMAIL: "test@c2d.local",
...
export function makeGitRepo(dir: string): void {
  git(dir, "init", "-b", "main");
  write(dir, "hello.txt", "Hello from Codex with DeepSeek Web!\n");
